{-|
Given a list of `Text` values (`needles`) and a single text
value (`haystack`) consecutively replaces all occurences of
the elements of `needles` as substrings in `haystack` with
the empty string.
